    ...
    if ($current_page !== 'admin.php' && $current_page !== 'admin-ventas.php' && $current_page !== 'admin-stock.php' && $current_page !== 'admin-destacados.php' && $current_page !== 'admin-ofertas.php' && $current_page !== 'admin-categorias.php' && !isset($_GET['no_preload'])):
    ?>
    <div id="preloader">
      <div class="line"></div>
    </div>
